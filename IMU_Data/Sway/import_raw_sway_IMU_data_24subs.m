...
raw_IMU_data_sub01_OS = xlsread('IMU_hexapod_sub01_sway_OS_00B4220E.xls');
raw_IMU_data_sub02_OS = xlsread('IMU_hexapod_sub02_sway_OS_00B4220E.xls');
raw_IMU_data_sub03_OS = xlsread('IMU_hexapod_sub03_sway_OS_00B4220E.xls');
raw_IMU_data_sub04_OS = xlsread('IMU_hexapod_sub04_sway_OS_00B4220E.xls');
raw_IMU_data_sub05_OS = xlsread('IMU_hexapod_sub05_sway_OS_00B4220E.xls');
raw_IMU_data_sub06_OS = xlsread('IMU_hexapod_sub06_sway_OS_00B4220E.xls');
raw_IMU_data_sub07_OS = xlsread('IMU_hexapod_sub07_sway_OS_00B4220E.xls');
raw_IMU_data_sub08_OS = xlsread('IMU_hexapod_sub08_sway_OS_00B4220E.xls');
raw_IMU_data_sub09_OS = xlsread('IMU_hexapod_sub09_sway_OS_00B4220E.xls');
raw_IMU_data_sub10_OS = xlsread('IMU_hexapod_sub10_sway_OS_00B4220E.xls');
raw_IMU_data_sub11_OS = xlsread('IMU_hexapod_sub11_sway_OS_00B4220E.xls');
raw_IMU_data_sub12_OS = xlsread('IMU_hexapod_sub12_sway_OS_00B4220E.xls');
raw_IMU_data_sub13_OS = xlsread('IMU_hexapod_sub13_sway_OS_00B4220E.xls');
raw_IMU_data_sub14_OS = xlsread('IMU_hexapod_sub14_sway_OS_00B4220E.xls');
raw_IMU_data_sub15_OS = xlsread('IMU_hexapod_sub15_sway_OS_00B4220E.xls');
raw_IMU_data_sub16_OS = xlsread('IMU_hexapod_sub16_sway_OS_00B4220E.xls');
raw_IMU_data_sub17_OS = xlsread('IMU_hexapod_sub17_sway_OS_00B4220E.xls');
raw_IMU_data_sub18_OS = xlsread('IMU_hexapod_sub18_sway_OS_00B4220E.xls');
raw_IMU_data_sub19_OS = xlsread('IMU_hexapod_sub19_sway_OS_00B4220E.xls');
raw_IMU_data_sub20_OS = xlsread('IMU_hexapod_sub20_sway_OS_00B4220E.xls');
raw_IMU_data_sub21_OS = xlsread('IMU_hexapod_sub21_sway_OS_00B4220E.xls');
raw_IMU_data_sub22_OS = xlsread('IMU_hexapod_sub22_sway_OS_00B4220E.xls');
raw_IMU_data_sub23_OS = xlsread('IMU_hexapod_sub23_sway_OS_00B4220E.xls');
raw_IMU_data_sub24_OS = xlsread('IMU_hexapod_sub24_sway_OS_00B4220E.xls');

% load data first trial 24 participants (t1 = trial 1)
raw_IMU_data_sub01_t1 = xlsread('IMU_hexapod_sub01_sway_t1_00B4220E.xls');
raw_IMU_data_sub02_t1 = xlsread('IMU_hexapod_sub02_sway_t1_00B4220E.xls');
raw_IMU_data_sub03_t1 = xlsread('IMU_hexapod_sub03_sway_t1_00B4220E.xls');
raw_IMU_data_sub04_t1 = xlsread('IMU_hexapod_sub04_sway_t1_00B4220E.xls');
raw_IMU_data_sub05_t1 = xlsread('IMU_hexapod_sub05_sway_t1_00B4220E.xls');
raw_IMU_data_sub06_t1 = xlsread('IMU_hexapod_sub06_sway_t1_00B4220E.xls');
raw_IMU_data_sub07_t1 = xlsread('IMU_hexapod_sub07_sway_t1_00B4220E.xls');
raw_IMU_data_sub08_t1 = xlsread('IMU_hexapod_sub08_sway_t1_00B4220E.xls');
raw_IMU_data_sub09_t1 = xlsread('IMU_hexapod_sub09_sway_t1_00B4220E.xls');
raw_IMU_data_sub10_t1 = xlsread('IMU_hexapod_sub10_sway_t1_00B4220E.xls');
raw_IMU_data_sub11_t1 = xlsread('IMU_hexapod_sub11_sway_t1_00B4220E.xls');
raw_IMU_data_sub12_t1 = xlsread('IMU_hexapod_sub12_sway_t1_00B4220E.xls');
raw_IMU_data_sub13_t1 = xlsread('IMU_hexapod_sub13_sway_t1_00B4220E.xls');
raw_IMU_data_sub14_t1 = xlsread('IMU_hexapod_sub14_sway_t1_00B4220E.xls');
raw_IMU_data_sub15_t1 = xlsread('IMU_hexapod_sub15_sway_t1_00B4220E.xls');
raw_IMU_data_sub16_t1 = xlsread('IMU_hexapod_sub16_sway_t1_00B4220E.xls');
raw_IMU_data_sub17_t1 = xlsread('IMU_hexapod_sub17_sway_t1_00B4220E.xls');
raw_IMU_data_sub18_t1 = xlsread('IMU_hexapod_sub18_sway_t1_00B4220E.xls');
raw_IMU_data_sub19_t1 = xlsread('IMU_hexapod_sub19_sway_t1_00B4220E.xls');
raw_IMU_data_sub20_t1 = xlsread('IMU_hexapod_sub20_sway_t1_00B4220E.xls');
raw_IMU_data_sub21_t1 = xlsread('IMU_hexapod_sub21_sway_t1_00B4220E.xls');
raw_IMU_data_sub22_t1 = xlsread('IMU_hexapod_sub22_sway_t1_00B4220E.xls');
raw_IMU_data_sub23_t1 = xlsread('IMU_hexapod_sub23_sway_t1_00B4220E.xls');
raw_IMU_data_sub24_t1 = xlsread('IMU_hexapod_sub24_sway_t1_00B4220E.xls');

% load data second trial for 24 participants (t2 = trial 2)
raw_IMU_data_sub01_t2 = xlsread('IMU_hexapod_sub01_sway_t2_00B4220E.xls');
raw_IMU_data_sub02_t2 = xlsread('IMU_hexapod_sub02_sway_t2_00B4220E.xls');
raw_IMU_data_sub03_t2 = xlsread('IMU_hexapod_sub03_sway_t2_00B4220E.xls');
raw_IMU_data_sub04_t2 = xlsread('IMU_hexapod_sub04_sway_t2_00B4220E.xls');
raw_IMU_data_sub05_t2 = xlsread('IMU_hexapod_sub05_sway_t2_00B4220E.xls');
raw_IMU_data_sub06_t2 = xlsread('IMU_hexapod_sub06_sway_t2_00B4220E.xls');
raw_IMU_data_sub07_t2 = xlsread('IMU_hexapod_sub07_sway_t2_00B4220E.xls');
raw_IMU_data_sub08_t2 = xlsread('IMU_hexapod_sub08_sway_t2_00B4220E.xls');
raw_IMU_data_sub09_t2 = xlsread('IMU_hexapod_sub09_sway_t2_00B4220E.xls');
raw_IMU_data_sub10_t2 = xlsread('IMU_hexapod_sub10_sway_t2_00B4220E.xls');
raw_IMU_data_sub11_t2 = xlsread('IMU_hexapod_sub11_sway_t2_00B4220E.xls');
raw_IMU_data_sub12_t2 = xlsread('IMU_hexapod_sub12_sway_t2_00B4220E.xls');
raw_IMU_data_sub13_t2 = xlsread('IMU_hexapod_sub13_sway_t2_00B4220E.xls');
raw_IMU_data_sub14_t2 = xlsread('IMU_hexapod_sub14_sway_t2_00B4220E.xls');
raw_IMU_data_sub15_t2 = xlsread('IMU_hexapod_sub15_sway_t2_00B4220E.xls');
raw_IMU_data_sub16_t2 = xlsread('IMU_hexapod_sub16_sway_t2_00B4220E.xls');
raw_IMU_data_sub17_t2 = xlsread('IMU_hexapod_sub17_sway_t2_00B4220E.xls');
raw_IMU_data_sub18_t2 = xlsread('IMU_hexapod_sub18_sway_t2_00B4220E.xls');
raw_IMU_data_sub19_t2 = xlsread('IMU_hexapod_sub19_sway_t2_00B4220E.xls');
raw_IMU_data_sub20_t2 = xlsread('IMU_hexapod_sub20_sway_t2_00B4220E.xls');
raw_IMU_data_sub21_t2 = xlsread('IMU_hexapod_sub21_sway_t2_00B4220E.xls');
raw_IMU_data_sub22_t2 = xlsread('IMU_hexapod_sub22_sway_t2_00B4220E.xls');
raw_IMU_data_sub23_t2 = xlsread('IMU_hexapod_sub23_sway_t2_00B4220E.xls');
raw_IMU_data_sub24_t2 = xlsread('IMU_hexapod_sub24_sway_t2_00B4220E.xls');

%% Delete rows and columns with no or useless data and make equal sized columns

% CHANGE THIS TO THE COLUMN NUMBER WHICH CONTAINS THE sway ACC. DATA
col_sway_acc = 8;
...
save(   'D:\gdialynas\Desktop\My files\Passive rider project\Msc_Jelle_de_hann\IMU_data\Sway IMU data\cell_array_sway_IMU_data_24subs.mat',...
