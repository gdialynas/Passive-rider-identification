%% Processing and analysing raw sway IMU data for 24 subjects
...
IMU_data  = load('cell_array_sway_IMU_data_24subs.mat');

%% Define the correct sign convention here
des_pert    = sway_acc_amp075;
clearvars sway_acc_amp075
...
outsider_signal=final_acc_t2(315:315,1:end)
bar(outsider_signal)
...
sway_acc_signals_SI_t1 = final_acc_t1; 
sway_acc_signals_SI_t2 = final_acc_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Msc_Jelle_de_hann\IMU_data\Sway IMU data\sway_acc_signals_SI_t1_t2.mat','sway_acc_signals_SI_t1','sway_acc_signals_SI_t2');
