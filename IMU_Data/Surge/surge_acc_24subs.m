%% Processing and analysing raw surge IMU data for 24 subjects
...
IMU_data  = load('cell_array_surge_IMU_data_24subs.mat');

%% Define the correct sign convention here
des_pert    = -surge_acc_amp075;
clearvars surge_acc_amp075
...
surge_acc_signals_SI_t1 = final_acc_t1; 
surge_acc_signals_SI_t2 = final_acc_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Msc_Jelle_de_hann\IMU_data\Surge IMU data\surge_acc_signals_SI_t1_t2.mat','surge_acc_signals_SI_t1','surge_acc_signals_SI_t2');
