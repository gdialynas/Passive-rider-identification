%% Processing and analysing raw roll IMU data for 24 subjects
...
IMU_data  = load('cell_array_roll_IMU_data_24subs.mat');
...
roll_vel_signals_SI_t1 = final_vel_t1; 
roll_vel_signals_SI_t2 = final_vel_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Msc_Jelle_de_hann\IMU_data\Roll IMU data\roll_vel_signals_SI_t1_t2.mat','roll_vel_signals_SI_t1','roll_vel_signals_SI_t2');
