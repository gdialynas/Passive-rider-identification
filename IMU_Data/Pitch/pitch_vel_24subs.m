%% Processing and analysing raw pitch IMU data for 24 subjects
...
IMU_data  = load('cell_array_pitch_IMU_data_24subs.mat');
...
pitch_vel_signals_SI_t1 = final_vel_t1; 
pitch_vel_signals_SI_t2 = final_vel_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Msc_Jelle_de_hann\IMU_data\Pitch IMU data\pitch_vel_signals_SI_t1_t2.mat','pitch_vel_signals_SI_t1','pitch_vel_signals_SI_t2');
