%% Processing and analysing raw surge IMU data of the upper body for 24 subjects

% Author: Jelle Waling de Haan
% Graduation project: Passive Rider Identification 
% Script: generating linear acceleration signals suitable for passive rider identification 
% Last update: 23-01-2019

% This script processes the raw surge IMU data for 24 subjects into final
...
IMU_data  = load('cell_array_surge_IMU_UB_data_24subs.mat');

%% Define the correct sign convention here
des_pert    = surge_acc_amp075;
clearvars surge_pert_amp075
...
final_acc_t1 = extract_pert_part_IMU(t1_aligned);
final_acc_t2 = extract_pert_part_IMU(t2_aligned);
...
surge_acc_UB_signals_SI_t1 = final_acc_t1; 
surge_acc_UB_signals_SI_t2 = final_acc_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\IMU_data\Upperbody\Surge\surge_acc_UB_signals_SI_t1_t2.mat','surge_acc_UB_signals_SI_t1','surge_acc_UB_signals_SI_t2');
