...
load('pitch_vel_signals_SI_t1_t2')     % input signal 
load('pitch_vel_upperbody_signals_SI_t1_t2')  % output signal 

%% Rename signals and choose trial number
%u_vel_hexapod_signals = pitch_vel_signals_SI_t1;    % Input vel. signals 24 subjects trial 1 
u_vel_hexapod_signals = pitch_vel_signals_SI_t2;   % Input vel. signals 24 subjects trial 2 

%y_vel_upperbody_signals = pitch_vel_upperbody_signals_SI_t1;  % velocity signals 24 subjects trial 1 
y_vel_upperbody_signals = pitch_vel_upperbody_signals_SI_t2; % velocity signals 24 subjects trial 2 

clearvars   pitch_vel_signals_SI_t1 pitch_vel_signals_SI_t2... 
            pitch_vel_upperbody_signals_SI_t1 pitch_vel_upperbody_signals_SI_t2
...
subplot(313)
    ...
    ylabel({'\gamma^2 [-]'})
    xlabel('Frequency [Hz]');
suptitle('Pitch Ang.vel.upperbody/Ang.vel.hexapod')
