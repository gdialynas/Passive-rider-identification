...
%wtf_phase_UB_sway   = phase_scaling2(wtf_phase_UB_sway);
...
[average_phase_X,std_phase_X]=averagePhase(wtf_UB_surge);
[average_phase_Y,std_phase_Y]=averagePhase(wtf_UB_sway);
[average_phase_Z,std_phase_Z]=averagePhase(wtf_UB_heave);
...
subplot(334)
    ...
    set(gca, 'XScale', 'log','FontSize',fontsize)
subplot(335)
  stdshade2(average_phase_Y,std_phase_Y,std_shadow,y_color,wfv,[]); hold on; grid on; box off
    xlim(x_lim_shade)
    xticks(x_ticks_shade)     
    %ylim([-180  180]);
    set(gca, 'XScale', 'log','FontSize',fontsize)
