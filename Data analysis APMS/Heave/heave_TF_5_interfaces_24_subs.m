...
wtf_phase_HBL_X = abs(wtf_phase_HBL_X).*-1; %Phase scaling for handlebar X-axis change all positive phase values to negative
...
wtf_phase_HBR_X = abs(wtf_phase_HBR_X).*-1; %Phase scaling for handlebar X-axis change all positive phase values to negative
