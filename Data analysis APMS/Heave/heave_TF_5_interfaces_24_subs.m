...
wtf_phase_HBL_X = -abs(unwrap(wtf_phase_HBL_X,tol)); %Phase scaling for handlebar X-axis change all positive phase values to negative
...
wtf_phase_HBR_X = -abs(unwrap(wtf_phase_HBR_X,tol)); %Phase scaling for handlebar X-axis change all positive phase values to negative
