...
wcoh_siglevel_linewidth = 2;    % linewidth for the significance coherence leven
...
wcoh_siglevel_color = 'k';      % black color for plot significance of coherence
...
subplot(3,6,7)
    ...
    title('Hexapod Acc.')
subplot(3,6,13)
    plot(u_acc_signals(:,sub),'Color', z_color); hold on; grid on; box off
    xlabel('Samples [-]');
...
subplot(3,6,18)
    ...
    suptitle('\bf Heave input and output signals in time domain');
...
subplot(3,6,16)
    ...
    xlabel('Samples [-]');
    ylabel('Force [N]');
    title(['FPR_Z: \mu=', num2str(mean(y_force_FPR_Z_24subs(:,sub))),' \sigma=', num2str(std(y_force_FPR_Z_24subs(:,sub)))]);
subplot(3,6,5)
...
subplot(3,6,18)
    ...
    suptitle('\bf Heave input and output signals with zero mean in time domain');
    
    
%% Comparison of left and right footpeg & handlebar forces
% The comparison will saw if there is a difference between the two sides
% this is done to evaluate if it is possible to merge the left & right
% footpegs and handlebars into a single plot for presentation reasons
...
subplot(5,3,2)
    ...
    title(['FPR_X: \mu=', num2str(mean(y_force_FPR_X_24subs(:,sub))),' \sigma=', num2str(std(y_force_FPR_X_24subs(:,sub)))]);
subplot(5,3,3)
    plot(y_force_FPL_X_24subs(:,sub)-y_force_FPR_X_24subs(:,sub),'Color', x_color); hold on; grid on; box off
    ylabel('Force [N]');
    title(['FPL_X - FPR_X: \mu=', num2str(mean(y_force_FPL_X_24subs(:,sub)-y_force_FPR_X_24subs(:,sub))),' \sigma=', num2str(std(y_force_FPL_X_24subs(:,sub)-y_force_FPR_X_24subs(:,sub)))]);
...
subplot(5,3,5)
    ...
    title(['FPR_Z: \mu=', num2str(mean(y_force_FPR_Z_24subs(:,sub))),' \sigma=', num2str(std(y_force_FPR_Z_24subs(:,sub)))]); 
subplot(5,3,6)
    plot(y_force_FPL_Z_24subs(:,sub)-y_force_FPR_Z_24subs(:,sub),'Color', z_color); hold on; grid on; box off
    ylabel('Force [N]');
    title(['FPL_Z - FPR_Z : \mu=', num2str(mean(y_force_FPL_Z_24subs(:,sub)-y_force_FPR_Z_24subs(:,sub))),' ,\sigma=', num2str(std(y_force_FPL_Z_24subs(:,sub)-y_force_FPR_Z_24subs(:,sub))),',RMS=',num2str(rms(y_force_FPL_Z_24subs(:,sub)-y_force_FPR_Z_24subs(:,sub)))]); 
...
subplot(5,3,8)
    ...
    title(['HBR_X: \mu=', num2str(mean(y_force_HBR_X_24subs(:,sub))),' \sigma=', num2str(std(y_force_HBR_X_24subs(:,sub)))]);  
 subplot(5,3,9)
    plot(y_force_HBL_X_24subs(:,sub)-y_force_HBR_X_24subs(:,sub),'Color', x_color); hold on; grid on; box off
    ylabel('Force [N]');
    title(['HBL_X-HBL_R: \mu=', num2str(mean(y_force_HBL_X_24subs(:,sub)-y_force_HBR_X_24subs(:,sub))),' \sigma=', num2str(std(y_force_HBL_X_24subs(:,sub)-y_force_HBR_X_24subs(:,sub)))]);  
...
subplot(5,3,11)
    ...
    title(['HBR_Z: \mu=', num2str(mean(y_force_HBR_Z_24subs(:,sub))),' \sigma=', num2str(std(y_force_HBR_Z_24subs(:,sub)))]);  
subplot(5,3,12)
    plot(y_force_HBL_Z_24subs(:,sub)-y_force_HBR_Z_24subs(:,sub),'Color', z_color); hold on; grid on; box off
    ylabel('Force [N]');
    title(['HBL_Z-HBR_Z: \mu=', num2str(mean(y_force_HBL_Z_24subs(:,sub)-y_force_HBR_Z_24subs(:,sub))),' \sigma=', num2str(std(y_force_HBL_Z_24subs(:,sub)-y_force_HBR_Z_24subs(:,sub)))]);
...
subplot(5,3,14)
    ...
    title(['HBR_Y: \mu=', num2str(mean(y_force_HBR_Y_24subs(:,sub))),' \sigma=', num2str(std(y_force_HBR_Y_24subs(:,sub)))]);  
subplot(5,3,15)
    plot(y_force_HBL_Y_24subs(:,sub)-y_force_HBR_Y_24subs(:,sub),'Color', y_color); hold on; grid on; box off
    ylabel('Force [N]');
    xlabel('Samples [-]');
    title(['HBL_Y-HBR_Y: \mu=', num2str(mean(y_force_HBL_Y_24subs(:,sub)-y_force_HBR_Y_24subs(:,sub))),' \sigma=', num2str(std(y_force_HBL_Y_24subs(:,sub)-y_force_HBR_Y_24subs(:,sub)))]); 
...
subplot(3,5,4)
    %hold on; grid on;
    loglog(wfv, wtf_mag_HBL_X, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off %1.14 is the crosstalk coefficient for the left handlebar for a vertical load
...
subplot(3,5,5)
    %hold on; grid on;
    loglog(wfv, wtf_mag_HBR_X, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off %1.86 is the crosstalk coefficient for the right handlebar for a vertical load
...
subplot(3,5,15)
    ...
    ylim(y_lim)
    xlabel('Frequency [Hz]');
    suptitle('\bf Heave gain loglogs for individual subjects and mean rider')
...
subplot(3,5,15)
    ...
    xticks(x_ticks)
    xlabel('Frequency [Hz]');
    suptitle('\bf Heave phase semilogxs for individual subjects and mean rider')
...
subplot(3,5,15)
    ...
    xticks(x_ticks)
    xlabel('Frequency [Hz]');
    suptitle('\bf Heave coherence plots for individual subjects and mean rider')
...
%     ylim([-180  180]);
    xticks(x_ticks)
     xlabel('Frequency [Hz]');
     set(gca, 'XScale', 'log')
 suptitle('\bf Heave gain plots mean rider')
...
%     ylim([-180  180]);
    xticks(x_ticks)
     xlabel('Frequency [Hz]');
     set(gca, 'XScale', 'log')
 suptitle('\bf Heave phase plots mean rider')
...
wcoh_HBLR_Z=(wcoh_HBL_Z+wcoh_HBR_Z)/2; %merging left and right handlebar z axis
 stdshade(wcoh_HBLR_Z',std_shadow,'b',wfv,[]); hold on; grid on; box off
    ...
    xticks(x_ticks)
     xlabel('Frequency [Hz]');
     set(gca, 'XScale', 'log')
 suptitle('\bf Heave coherence plots mean rider')
