...
load('sway_acc_signals_SI_t1_t2')   % input signal (m/s^2)
load('sway_force_signals_SI_t1_t2') % output signal (N)
...
u_acc_signals = -sway_acc_signals_SI_t1;    % Acc. signals 24 subjects trial 1 
%u_acc_signals = -sway_acc_signals_SI_t2;   % Acc. signals 24 subjects trial 2 

y_force_signals = sway_force_signals_SI_t1;  % Force signals 24 subjects trial 1 
%y_force_signals = sway_force_signals_SI_t2; % Force signals 24 subjects trial 2 

clearvars   sway_acc_signals_SI_t1 sway_acc_signals_SI_t2... 
            sway_force_signals_SI_t1 sway_force_signals_SI_t2
...
x_lim           = [0.16 12];                       % x-axis limit for frequency range
...
subplot(3,6,1)
    ...
    xlabel('Samples [-]');
    ylabel({'\bf X-axis','Acc. [m/s^2]'})
    title(['Hexapod Acc.: \mu=', num2str(mean(u_acc_signals(:,sub))),' \sigma=', num2str(std(u_acc_signals(:,sub)))])
subplot(3,6,7)
    plot(u_acc_signals(:,sub),'Color', y_color); hold on; grid on; box off
    xlabel('Samples [-]');
    ylabel({'\bf Y-axis','Acc. [m/s^2]'})
    title('Hexapod Acc.')
subplot(3,6,13)
    line([0,length(u_acc_signals(:,sub))],[0,0],'Color', z_color); hold on; grid on; box off
    xlabel('Samples [-]');
    ylabel({'\bf Z-axis','Acc. [m/s^2]'})
    title('Hexapod Acc.')
subplot(3,6,2)
...
subplot(3,6,18)
    ...
    suptitle('\bf Sway input and output signals in time domain');
...
subplot(3,6,1)
    ...
    title('Hexapod Acc.')
subplot(3,6,7)
    plot(fv(1:N/2),U_acc_signals(1:N/2),'Color', y_color); hold on; grid on; box off
    xlabel('Frequency [Hz]');
...
subplot(3,6,13)
    ...
    title('Hexapod Acc.')
subplot(3,6,2)
    plot(fv(1:N/2),Y_force_SP_X_24subs(1:N/2),'Color', x_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force SP_X');
subplot(3,6,8)
    plot(fv(1:N/2),Y_force_SP_Y_24subs(1:N/2),'Color', y_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force SP_Y');
subplot(3,6,14)
    plot(fv(1:N/2),Y_force_SP_Z_24subs(1:N/2),'Color', z_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    xlabel('Frequency [Hz]');
    title('Force SP_Z');
subplot(3,6,3)
    plot(fv(1:N/2),Y_force_FPL_X_24subs(1:N/2),'Color', x_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force FPL_X');
subplot(3,6,15)
    plot(fv(1:N/2),Y_force_FPL_Z_24subs(1:N/2),'Color', z_color); hold on; grid on; box off
    xlabel('Frequency [Hz]');
    ylabel('Magnitude [-]');
    title('Force FPL_Z');
subplot(3,6,4)
    plot(fv(1:N/2),Y_force_FPR_X_24subs(1:N/2),'Color', x_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force FPR_X');
subplot(3,6,16)
    plot(fv(1:N/2),Y_force_FPR_Z_24subs(1:N/2),'Color', z_color); hold on; grid on; box off
    xlabel('Frequency [Hz]');
    ylabel('Magnitude [-]');
    title('Force FPR_Z');
subplot(3,6,5)
    plot(fv(1:N/2),Y_force_HBL_X_24subs(1:N/2),'Color', x_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force HBL_X');
subplot(3,6,11)
    plot(fv(1:N/2),Y_force_HBL_Y_24subs(1:N/2),'Color', y_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force HBL_Y');
subplot(3,6,17)
    plot(fv(1:N/2),Y_force_HBL_Z_24subs(1:N/2),'Color', z_color); hold on; grid on; box off
    xlabel('Frequency [Hz]');
    ylabel('Magnitude [-]');
    title('Force HBL_Z');
subplot(3,6,6)
    plot(fv(1:N/2),Y_force_HBR_X_24subs(1:N/2),'Color', x_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force HBR_X');
subplot(3,6,12)
    plot(fv(1:N/2),Y_force_HBR_Y_24subs(1:N/2),'Color', y_color); hold on; grid on; box off
    ylabel('Magnitude [-]');
    title('Force HBR_Y');
subplot(3,6,18)
    plot(fv(1:N/2),Y_force_HBR_Z_24subs(1:N/2),'Color', z_color); hold on; grid on; box off
    xlabel('Frequency [Hz]');
    ylabel('Magnitude [-]');
    title('Force HBR_Z');
    suptitle('\bf Sway input and output signals in frequency domain');
...
subplot(3,6,1)
    line([0,length(u_acc_signals(:,sub))],[0,0],'Color', x_color); hold on; grid on; box off
    xlabel('Samples [-]');
    ylabel({'\bfX-axis','Acc. [m/s^2]'})
    title(['Hexapod Acc.: \mu=', num2str(mean(u_acc_signals(:,sub))),' \sigma=', num2str(std(u_acc_signals(:,sub)))])
subplot(3,6,7)
    plot(u_acc_signals(:,sub),'Color', y_color); hold on; grid on; box off
    xlabel('Samples [-]');
    ylabel({'\bfY-axis','Acc. [m/s^2]'})
    title('Hexapod Acc.')
subplot(3,6,13)
    line([0,length(u_acc_signals(:,sub))],[0,0],'Color', z_color); hold on; grid on; box off
    xlabel('Samples [-]');
    ylabel({'\bfZ-axis','Acc. [m/s^2]'})
    title('Hexapod Acc.')
subplot(3,6,2)
...
subplot(3,6,18)
    ...
    suptitle('\bf Sway input and output signals with zero mean in time domain');
...
subplot(3,5,15)
    ...
    ylim(y_lim)
    xlabel('Frequency [Hz]');
    suptitle('\bf Sway gain loglogs for individual subjects and mean rider')
...
%     ylim([-180  180]);
    xticks(x_ticks)
    xlabel('Frequency [Hz]');
    suptitle('\bf Sway phase semilogxs for individual subjects and mean rider')
...
subplot(3,5,15)
   ...
   semilogx(wfv, wcoh_HBR_Z_mean_rider, 'linewidth', mean_linewidth, 'Color', z_color); hold on; grid on; box off
    ...
    xticks(x_ticks)
    xlabel('Frequency [Hz]');
    suptitle('\bf Sway coherence semilogxs for individual subjects and mean rider')
...
%     ylim([-180  180]);
    xticks(x_ticks)
     xlabel('Frequency [Hz]');
     set(gca, 'XScale', 'log')
 suptitle('\bf Sway gain plots mean rider')
...
%     ylim([-180  180]);
    xticks(x_ticks)
     xlabel('Frequency [Hz]');
     set(gca, 'XScale', 'log')
 suptitle('\bf Sway phase plots mean rider')
...
wcoh_HBLR_Z=(wcoh_HBL_Z+wcoh_HBR_Z)/2; %merging left and right handlebar z axis
 stdshade(wcoh_HBLR_Z',std_shadow,'b',wfv,[]); hold on; grid on; box off
    ...
    xticks(x_ticks)
     xlabel('Frequency [Hz]');
     set(gca, 'XScale', 'log')
 suptitle('\bf Sway coherence plots mean rider')
...
% subplot(3,5,1)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_SP_X_norm,'Color', indv_color, 'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_SP_X_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', x_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks) 
%     yticks(y_ticks_norm) 
...
% subplot(3,5,6)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_SP_Y_norm, 'Color', indv_color, 'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_SP_Y_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', y_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,11)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_SP_Z_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_SP_Z_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', z_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,2)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_FPL_X_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_FPL_X_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', x_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,12)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_FPL_Z_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_FPL_Z_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', z_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,3)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_FPR_X_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_FPR_X_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', x_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,13)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_FPR_Z_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_FPR_Z_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', z_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,4)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_HBL_X_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_HBL_X_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', x_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,9)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_HBL_Y_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_HBL_Y_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', y_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,14)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_HBL_Z_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_HBL_Z_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', z_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm)
...
% subplot(3,5,5)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_HBR_X_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_HBR_X_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', x_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm)
...
% subplot(3,5,10)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_HBR_Y_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_HBR_Y_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', y_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
...
% subplot(3,5,15)
%     %hold on; grid on;
%     plot(wfv, wtf_mag_HBR_Z_norm, 'Color', indv_color,'linewidth', indv_linewidth); hold on; grid on; box off
%     plot(wfv, wtf_mag_HBR_Z_mean_rider_norm, 'linewidth', mean_linewidth, 'Color', z_color); hold on; grid on; box off
%     xlim([1 12]);
%     ylim(y_lim_norm)
%     xticks(x_ticks)
%     yticks(y_ticks_norm) 
%     yticklabels({'0.001', '0.01', '0.1', '1', '10'})
%     xlabel('Frequency [Hz]');
%     suptitle('\bf Sway normalised gain plots for individual subjects and mean rider')
