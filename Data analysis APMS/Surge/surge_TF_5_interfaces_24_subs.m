...
wtf_phase_FPL_Z = abs(wtf_phase_FPL_Z).*-1; %CHANGE SIGN CONVENTIONS
...
wtf_phase_FPR_Z = abs(wtf_phase_FPR_Z).*-1; %CHANGE SIGN CONVENTIONS
...
wtf_phase_HBL_Z = abs(wtf_phase_HBL_Z).*-1; %CHANGE SIGN CONVENTIONS
...
wtf_phase_HBR_Z = abs(wtf_phase_HBR_Z).*-1; %CHANGE SIGN CONVENTIONS
