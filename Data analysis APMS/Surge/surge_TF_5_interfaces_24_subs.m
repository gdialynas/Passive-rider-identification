...
ind = wtf_phase_FPL_Z>0;
wtf_phase_FPL_Z(ind) = wtf_phase_FPL_Z(ind) - 360;
...
%CHANGE SIGN CONVENTIONS
ind = wtf_phase_FPR_Z>0;
wtf_phase_FPR_Z(ind) = wtf_phase_FPR_Z(ind) - 360;
...
%CHANGE SIGN CONVENTIONS
ind = wtf_phase_HBL_Z>0;
wtf_phase_HBL_Z(ind) = wtf_phase_HBL_Z(ind) - 360;
...
%CHANGE SIGN CONVENTIONS
ind = wtf_phase_HBR_Z>0;
wtf_phase_HBR_Z(ind) = wtf_phase_HBR_Z(ind) - 360;
