%% Processing and analysing raw roll force data for all interfaces for 24 subjects

% This script processes the raw roll force data for 24 subjects into final
...
load('roll_pert_amp1'); 
clearvars roll_vel_amp1 roll_dis_amp1

% !!! LOAD mat-file FOR CORRECT MOTION HERE !!!
% Measured force signals
load('cell_array_roll_force_24subs.mat');
...
crosstalk_handlebars = xlsread('crosstalk_calibration_handlebars_roll.xlsx');

%% Define the correct sign convention here
des_pert    = roll_acc_amp1;

%% Genereta cell structure (DO NOT CHANGE!)
force_data = {roll_force_24subs_OS,roll_force_24subs_t1,roll_force_24subs_t2};
clearvars roll_force_24subs_OS roll_force_24subs_t1 roll_force_24subs_t2
...
roll_force_signals_SI_t1 = final_forces_t1; 
roll_force_signals_SI_t2 = final_forces_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\Roll\Roll strain gauge data/roll_force_signals_SI_t1_t2.mat','roll_force_signals_SI_t1','roll_force_signals_SI_t2');