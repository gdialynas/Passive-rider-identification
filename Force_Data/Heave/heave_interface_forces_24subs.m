%% Processing and analysing raw heave force data for all interfaces for 24 subjects
...
% This script processes the raw heave force data for 24 subjects into
...
load('cell_array_heave_force_24subs.mat');
...
crosstalk_handlebars = xlsread('crosstalk_calibration_handlebars_heave.xlsx');

%% Define the correct sign convention
des_pert = heave_acc_amp1;

%% Genereta cell structure (DO NOT CHANGE!)
force_data = {heave_force_24subs_OS,heave_force_24subs_t1,heave_force_24subs_t2};
clearvars heave_force_24subs_OS heave_force_24subs_t1 heave_force_24subs_t2
...
heave_force_signals_SI_t1 = final_forces_t1; 
heave_force_signals_SI_t2 = final_forces_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\Heave\Heave\Heave\Heave strain gauge data\heave_force_signals_SI_t1_t2.mat','heave_force_signals_SI_t1','heave_force_signals_SI_t2');