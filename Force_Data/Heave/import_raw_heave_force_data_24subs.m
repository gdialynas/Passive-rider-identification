%% Generating cell arrays for all interface forces for 24 subjects

% Author: Jelle Waling de Haan
% Graduation project: Passive Rider Identification
% script: converting raw force data into .mat files
% Last update: 23-01-2019

% This script is generated because matlab cannot compile directly the force
% data excel files from LABVIEW. This script imports the csv files, 
% after which the cell arrays are converted to mat arrays to delete the last
...
% load data offset trial for 24 subjects (OS = offset trial)
cell_data_sub01_OS  = csvimport('sub01_heave_OS.xls');
cell_data_sub02_OS  = csvimport('sub02_heave_OS.xls');
cell_data_sub03_OS  = csvimport('sub03_heave_OS.xls');
cell_data_sub04_OS  = csvimport('sub04_heave_OS.xls');
cell_data_sub05_OS  = csvimport('sub05_heave_OS.xls');
cell_data_sub06_OS  = csvimport('sub06_heave_OS.xls');
cell_data_sub07_OS  = csvimport('sub07_heave_OS.xls');
cell_data_sub08_OS  = csvimport('sub08_heave_OS.xls');
cell_data_sub09_OS  = csvimport('sub09_heave_OS.xls');
cell_data_sub10_OS  = csvimport('sub10_heave_OS.xls');
cell_data_sub11_OS  = csvimport('sub11_heave_OS.xls');
cell_data_sub12_OS  = csvimport('sub12_heave_OS.xls');
cell_data_sub13_OS  = csvimport('sub13_heave_OS.xls');
cell_data_sub14_OS  = csvimport('sub14_heave_OS.xls');
cell_data_sub15_OS  = csvimport('sub15_heave_OS.xls');
cell_data_sub16_OS  = csvimport('sub16_heave_OS.xls');
cell_data_sub17_OS  = csvimport('sub17_heave_OS.xls');
cell_data_sub18_OS  = csvimport('sub18_heave_OS.xls');
cell_data_sub19_OS  = csvimport('sub19_heave_OS.xls');
cell_data_sub20_OS  = csvimport('sub20_heave_OS.xls');
cell_data_sub21_OS  = csvimport('sub21_heave_OS.xls');
cell_data_sub22_OS  = csvimport('sub22_heave_OS.xls');
cell_data_sub23_OS  = csvimport('sub23_heave_OS.xls');
cell_data_sub24_OS  = csvimport('sub24_heave_OS.xls');

% load data first trial 24 subjects (t1 = trial 1)
cell_data_sub01_t1  = csvimport('sub01_heave_t1.xls');
cell_data_sub02_t1  = csvimport('sub02_heave_t1.xls');
cell_data_sub03_t1  = csvimport('sub03_heave_t1.xls');
cell_data_sub04_t1  = csvimport('sub04_heave_t1.xls');
cell_data_sub05_t1  = csvimport('sub05_heave_t1.xls');
cell_data_sub06_t1  = csvimport('sub06_heave_t1.xls');
cell_data_sub07_t1  = csvimport('sub07_heave_t1.xls');
cell_data_sub08_t1  = csvimport('sub08_heave_t1.xls');
cell_data_sub09_t1  = csvimport('sub09_heave_t1.xls');
cell_data_sub10_t1  = csvimport('sub10_heave_t1.xls');
cell_data_sub11_t1  = csvimport('sub11_heave_t1.xls');
cell_data_sub12_t1  = csvimport('sub12_heave_t1.xls');
cell_data_sub13_t1  = csvimport('sub13_heave_t1.xls');
cell_data_sub14_t1  = csvimport('sub14_heave_t1.xls');
cell_data_sub15_t1  = csvimport('sub15_heave_t1.xls');
cell_data_sub16_t1  = csvimport('sub16_heave_t1.xls');
cell_data_sub17_t1  = csvimport('sub17_heave_t1.xls');
cell_data_sub18_t1  = csvimport('sub18_heave_t1.xls');
cell_data_sub19_t1  = csvimport('sub19_heave_t1.xls');
cell_data_sub20_t1  = csvimport('sub20_heave_t1.xls');
cell_data_sub21_t1  = csvimport('sub21_heave_t1.xls');
cell_data_sub22_t1  = csvimport('sub22_heave_t1.xls');
cell_data_sub23_t1  = csvimport('sub23_heave_t1.xls');
cell_data_sub24_t1  = csvimport('sub24_heave_t1.xls');

% load data second trial for 24 subjects (t2 = trial 2)
cell_data_sub01_t2  = csvimport('sub01_heave_t2.xls');
cell_data_sub02_t2  = csvimport('sub02_heave_t2.xls');
cell_data_sub03_t2  = csvimport('sub03_heave_t2.xls');
cell_data_sub04_t2  = csvimport('sub04_heave_t2.xls');
cell_data_sub05_t2  = csvimport('sub05_heave_t2.xls');
cell_data_sub06_t2  = csvimport('sub06_heave_t2.xls');
cell_data_sub07_t2  = csvimport('sub07_heave_t2.xls');
cell_data_sub08_t2  = csvimport('sub08_heave_t2.xls');
cell_data_sub09_t2  = csvimport('sub09_heave_t2.xls');
cell_data_sub10_t2  = csvimport('sub10_heave_t2.xls');
cell_data_sub11_t2  = csvimport('sub11_heave_t2.xls');
cell_data_sub12_t2  = csvimport('sub12_heave_t2.xls');
cell_data_sub13_t2  = csvimport('sub13_heave_t2.xls');
cell_data_sub14_t2  = csvimport('sub14_heave_t2.xls');
cell_data_sub15_t2  = csvimport('sub15_heave_t2.xls');
cell_data_sub16_t2  = csvimport('sub16_heave_t2.xls');
cell_data_sub17_t2  = csvimport('sub17_heave_t2.xls');
cell_data_sub18_t2  = csvimport('sub18_heave_t2.xls');
cell_data_sub19_t2  = csvimport('sub19_heave_t2.xls');
cell_data_sub20_t2  = csvimport('sub20_heave_t2.xls');
cell_data_sub21_t2  = csvimport('sub21_heave_t2.xls');
cell_data_sub22_t2  = csvimport('sub22_heave_t2.xls');
cell_data_sub23_t2  = csvimport('sub23_heave_t2.xls');
cell_data_sub24_t2  = csvimport('sub24_heave_t2.xls');

%% Convert cell arrays to matrices
% Convert cell arrays to matrices for offset trial for 24 subjects
...
% Convert cell arrays to matrices for first trial for 24 subjects
...
% Convert cell arrays to matrices for second trial for 24 subjects
...
% Delete last 3 columns (no force data) for offset trials for 24 subjects 
...
% Delete last 3 columns (no force data) for first trials for 24 subjects 
...
% Delete last 3 columns (no force data) for second trials for 24 subjects 
...
% Generate one cell array with force data from the offset trials for 24 subjects
heave_force_24subs_OS  = {  mat_force_data_sub01_OS, mat_force_data_sub02_OS, mat_force_data_sub03_OS, mat_force_data_sub04_OS, mat_force_data_sub05_OS,...
...
% Generate one cell array with all force data from the first trials for 24 subjects
heave_force_24subs_t1  = {  mat_force_data_sub01_t1, mat_force_data_sub02_t1, mat_force_data_sub03_t1, mat_force_data_sub04_t1, mat_force_data_sub05_t1,...
...
% Generate one cell array with all force data from the second trials for 24 subjects
heave_force_24subs_t2  = {  mat_force_data_sub01_t2, mat_force_data_sub02_t2, mat_force_data_sub03_t2, mat_force_data_sub04_t2, mat_force_data_sub05_t2,...
...
% Store all interface forces in a .mat files for 24 subjects for all trials 
save(   'D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\Heave\Heave\Heave\Heave strain gauge data\cell_array_heave_force_24subs.mat',...
        'heave_force_24subs_OS','heave_force_24subs_t1','heave_force_24subs_t2');
