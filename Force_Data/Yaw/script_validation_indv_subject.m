...
cell_raw_data_sub_t1  = csvimport('sub01_yaw_t1.xls'); % t1 = trial 1
cell_raw_data_sub_t2  = csvimport('sub01_yaw_t2.xls'); % t2 = trial 2

% !!! CHANGE DESIGNED PERTURBATION FOR CORRECT MOTION HERE !!! 
% Designed perturbation signal (for all participants the same)
load('yaw_pert_amp1'); % designed signal is used for signal alignment
...
save('D:\gdialynas\Desktop\My files\Passive rider project\Msc_Jelle_de_hann\Passive Rider Identification\Yaw\validation_force_indv_sub.mat','total_force_indv_sub_t1')
