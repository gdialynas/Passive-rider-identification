%% Processing and analysing raw yaw force data for all interfaces for 24 subjects

% This script processes the raw yaw force data for 24 subjects into final
...
load('yaw_pert_amp1'); 
clearvars yaw_vel_amp1 yaw_dis_amp1

% !!! LOAD mat-file FOR CORRECT MOTION HERE !!!
% Measured force signals
load('cell_array_yaw_force_24subs.mat');
...
crosstalk_handlebars = xlsread('crosstalk_calibration_handlebars_yaw.xlsx');

%% Define the correct sign convention here
des_pert    = yaw_acc_amp1;

%% Genereta cell structure (DO NOT CHANGE!)
force_data = {yaw_force_24subs_OS,yaw_force_24subs_t1,yaw_force_24subs_t2};
clearvars yaw_force_24subs_OS yaw_force_24subs_t1 yaw_force_24subs_t2
...
yaw_force_signals_SI_t1 = final_forces_t1; 
yaw_force_signals_SI_t2 = final_forces_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\Yaw\Yaw strain gauge data\yaw_force_signals_SI_t1_t2.mat','yaw_force_signals_SI_t1','yaw_force_signals_SI_t2');