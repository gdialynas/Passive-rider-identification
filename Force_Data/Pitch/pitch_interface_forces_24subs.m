%% Processing and analysing raw pitch force data for all interfaces for 24 subjects

% This script processes the raw pitch force data for 24 subjects into final
...
load('pitch_pert_amp05'); 
clearvars pitch_vel_amp05 pitch_dis_amp05

% !!! LOAD mat-file FOR CORRECT MOTION HERE !!!
% Measured force signals
load('cell_array_pitch_force_24subs.mat');
...
crosstalk_handlebars = xlsread('crosstalk_calibration_handlebars_pitch.xlsx');

%% Define the correct sign convention here
des_pert    = pitch_acc_amp05;

%% Genereta cell structure (DO NOT CHANGE!)
force_data = {pitch_force_24subs_OS,pitch_force_24subs_t1,pitch_force_24subs_t2};
clearvars pitch_force_24subs_OS pitch_force_24subs_t1 pitch_force_24subs_t2
...
pitch_force_signals_SI_t1 = final_forces_t1; 
pitch_force_signals_SI_t2 = final_forces_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\Pitch\Pitch strain gauge data\pitch_force_signals_SI_t1_t2.mat','pitch_force_signals_SI_t1','pitch_force_signals_SI_t2');