...
cell_data_sub01_OS  = csvimport('sub01_pitch_OS.xls');
cell_data_sub02_OS  = csvimport('sub02_pitch_OS.xls');
cell_data_sub03_OS  = csvimport('sub03_pitch_OS.xls');
cell_data_sub04_OS  = csvimport('sub04_pitch_OS.xls');
cell_data_sub05_OS  = csvimport('sub05_pitch_OS.xls');
cell_data_sub06_OS  = csvimport('sub06_pitch_OS.xls');
cell_data_sub07_OS  = csvimport('sub07_pitch_OS.xls');
cell_data_sub08_OS  = csvimport('sub08_pitch_OS.xls');
cell_data_sub09_OS  = csvimport('sub09_pitch_OS.xls');
cell_data_sub10_OS  = csvimport('sub10_pitch_OS.xls');
cell_data_sub11_OS  = csvimport('sub11_pitch_OS.xls');
cell_data_sub12_OS  = csvimport('sub12_pitch_OS.xls');
cell_data_sub13_OS  = csvimport('sub13_pitch_OS.xls');
cell_data_sub14_OS  = csvimport('sub14_pitch_OS.xls');
cell_data_sub15_OS  = csvimport('sub15_pitch_OS.xls');
cell_data_sub16_OS  = csvimport('sub16_pitch_OS.xls');
cell_data_sub17_OS  = csvimport('sub17_pitch_OS.xls');
cell_data_sub18_OS  = csvimport('sub18_pitch_OS.xls');
cell_data_sub19_OS  = csvimport('sub19_pitch_OS.xls');
cell_data_sub20_OS  = csvimport('sub20_pitch_OS.xls');
cell_data_sub21_OS  = csvimport('sub21_pitch_OS.xls');
cell_data_sub22_OS  = csvimport('sub22_pitch_OS.xls');
cell_data_sub23_OS  = csvimport('sub23_pitch_OS.xls');
cell_data_sub24_OS  = csvimport('sub24_pitch_OS.xls');

% load data first trial 24 participants (t1 = trial 1)
cell_data_sub01_t1  = csvimport('sub01_pitch_t1.xls');
cell_data_sub02_t1  = csvimport('sub02_pitch_t1.xls');
cell_data_sub03_t1  = csvimport('sub03_pitch_t1.xls');
cell_data_sub04_t1  = csvimport('sub04_pitch_t1.xls');
cell_data_sub05_t1  = csvimport('sub05_pitch_t1.xls');
cell_data_sub06_t1  = csvimport('sub06_pitch_t1.xls');
cell_data_sub07_t1  = csvimport('sub07_pitch_t1.xls');
cell_data_sub08_t1  = csvimport('sub08_pitch_t1.xls');
cell_data_sub09_t1  = csvimport('sub09_pitch_t1.xls');
cell_data_sub10_t1  = csvimport('sub10_pitch_t1.xls');
cell_data_sub11_t1  = csvimport('sub11_pitch_t1.xls');
cell_data_sub12_t1  = csvimport('sub12_pitch_t1.xls');
cell_data_sub13_t1  = csvimport('sub13_pitch_t1.xls');
cell_data_sub14_t1  = csvimport('sub14_pitch_t1.xls');
cell_data_sub15_t1  = csvimport('sub15_pitch_t1.xls');
cell_data_sub16_t1  = csvimport('sub16_pitch_t1.xls');
cell_data_sub17_t1  = csvimport('sub17_pitch_t1.xls');
cell_data_sub18_t1  = csvimport('sub18_pitch_t1.xls');
cell_data_sub19_t1  = csvimport('sub19_pitch_t1.xls');
cell_data_sub20_t1  = csvimport('sub20_pitch_t1.xls');
cell_data_sub21_t1  = csvimport('sub21_pitch_t1.xls');
cell_data_sub22_t1  = csvimport('sub22_pitch_t1.xls');
cell_data_sub23_t1  = csvimport('sub23_pitch_t1.xls');
cell_data_sub24_t1  = csvimport('sub24_pitch_t1.xls');

% load data second trial for 24 participants (t2 = trial 2)
cell_data_sub01_t2  = csvimport('sub01_pitch_t2.xls');
cell_data_sub02_t2  = csvimport('sub02_pitch_t2.xls');
cell_data_sub03_t2  = csvimport('sub03_pitch_t2.xls');
cell_data_sub04_t2  = csvimport('sub04_pitch_t2.xls');
cell_data_sub05_t2  = csvimport('sub05_pitch_t2.xls');
cell_data_sub06_t2  = csvimport('sub06_pitch_t2.xls');
cell_data_sub07_t2  = csvimport('sub07_pitch_t2.xls');
cell_data_sub08_t2  = csvimport('sub08_pitch_t2.xls');
cell_data_sub09_t2  = csvimport('sub09_pitch_t2.xls');
cell_data_sub10_t2  = csvimport('sub10_pitch_t2.xls');
cell_data_sub11_t2  = csvimport('sub11_pitch_t2.xls');
cell_data_sub12_t2  = csvimport('sub12_pitch_t2.xls');
cell_data_sub13_t2  = csvimport('sub13_pitch_t2.xls');
cell_data_sub14_t2  = csvimport('sub14_pitch_t2.xls');
cell_data_sub15_t2  = csvimport('sub15_pitch_t2.xls');
cell_data_sub16_t2  = csvimport('sub16_pitch_t2.xls');
cell_data_sub17_t2  = csvimport('sub17_pitch_t2.xls');
cell_data_sub18_t2  = csvimport('sub18_pitch_t2.xls');
cell_data_sub19_t2  = csvimport('sub19_pitch_t2.xls');
cell_data_sub20_t2  = csvimport('sub20_pitch_t2.xls');
cell_data_sub21_t2  = csvimport('sub21_pitch_t2.xls');
cell_data_sub22_t2  = csvimport('sub22_pitch_t2.xls');
cell_data_sub23_t2  = csvimport('sub23_pitch_t2.xls');
cell_data_sub24_t2  = csvimport('sub24_pitch_t2.xls');
...
save(   'D:\gdialynas\Desktop\My files\Passive rider project\Msc_Jelle_de_hann\Passive Rider Identification\Pitch\cell_array_pitch_force_24subs.mat',...
