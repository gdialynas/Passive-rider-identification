%% Processing and analysing raw surge force data for all interfaces for 24 subjects
...
% This script processes the raw surge force data for 24 subjects into
...
load('surge_pert_amp075'); 
clearvars surge_vel_amp075 surge_dis_amp075

% !!! LOAD mat-file FOR CORRECT MOTION HERE !!!
% Measured force signals
load('cell_array_surge_force_24subs.mat');
...
crosstalk_handlebars = xlsread('crosstalk_calibration_handlebars_surge.xlsx');

%% Define the correct sign convention
des_pert = surge_acc_amp075;

%% Genereta cell structure (DO NOT CHANGE!)
force_data = {surge_force_24subs_OS,surge_force_24subs_t1,surge_force_24subs_t2};
clearvars surge_force_24subs_OS surge_force_24subs_t1 surge_force_24subs_t2
...
surge_force_signals_SI_t1 = final_forces_t1; 
surge_force_signals_SI_t2 = final_forces_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\Surge\Surge strain gauge data\surge_force_signals_SI_t1_t2.mat','surge_force_signals_SI_t1','surge_force_signals_SI_t2');