%% Processing and analysing raw yaw IMU data for upperbody for 24 subjects
...
IMU_data  = load('cell_array_yaw_upperbody_IMU_data_24subs.mat');
...
yaw_vel_upperbody_signals_SI_t1 = final_vel_t1; 
yaw_vel_upperbody_signals_SI_t2 = final_vel_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\IMU_data\Upperbody\Yaw\yaw_vel_upperbody_signals_SI_t1_t2.mat','yaw_vel_upperbody_signals_SI_t1','yaw_vel_upperbody_signals_SI_t2');
