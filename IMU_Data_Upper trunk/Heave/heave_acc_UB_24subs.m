%% Processing and analysing raw heave IMU data of the upper body for 24 subjects
...
IMU_data  = load('cell_array_heave_IMU_UB_data_24subs.mat');
...
heave_acc_UB_signals_SI_t1 = final_acc_t1; 
heave_acc_UB_signals_SI_t2 = final_acc_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\IMU_data\Upperbody\Heave\heave_acc_UB_signals_SI_t1_t2.mat','heave_acc_UB_signals_SI_t1','heave_acc_UB_signals_SI_t2');
