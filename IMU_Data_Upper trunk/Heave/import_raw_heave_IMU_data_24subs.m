%% Generating cell arrays for linear heave upper body accelerations for 24 subjects
...
raw_IMU_data_sub01_OS = xlsread('IMU_upperbody_sub01_heave_OS_00B4242B.xls');
raw_IMU_data_sub02_OS = xlsread('IMU_upperbody_sub02_heave_OS_00B4242B.xls');
raw_IMU_data_sub03_OS = xlsread('IMU_upperbody_sub03_heave_OS_00B4242B.xls');
raw_IMU_data_sub04_OS = xlsread('IMU_upperbody_sub04_heave_OS_00B4242B.xls');
raw_IMU_data_sub05_OS = xlsread('IMU_upperbody_sub05_heave_OS_00B4242B.xls');
raw_IMU_data_sub06_OS = xlsread('IMU_upperbody_sub06_heave_OS_00B4242B.xls');
raw_IMU_data_sub07_OS = xlsread('IMU_upperbody_sub07_heave_OS_00B4242B.xls');
raw_IMU_data_sub08_OS = xlsread('IMU_upperbody_sub08_heave_OS_00B4242B.xls');
raw_IMU_data_sub09_OS = xlsread('IMU_upperbody_sub09_heave_OS_00B4242B.xls');
raw_IMU_data_sub10_OS = xlsread('IMU_upperbody_sub10_heave_OS_00B4242B.xls');
raw_IMU_data_sub11_OS = xlsread('IMU_upperbody_sub11_heave_OS_00B4242B.xls');
raw_IMU_data_sub12_OS = xlsread('IMU_upperbody_sub12_heave_OS_00B4242B.xls');
raw_IMU_data_sub13_OS = xlsread('IMU_upperbody_sub13_heave_OS_00B4242B.xls');
raw_IMU_data_sub14_OS = xlsread('IMU_upperbody_sub14_heave_OS_00B4242B.xls');
raw_IMU_data_sub15_OS = xlsread('IMU_upperbody_sub15_heave_OS_00B4242B.xls');
raw_IMU_data_sub16_OS = xlsread('IMU_upperbody_sub16_heave_OS_00B4242B.xls');
raw_IMU_data_sub17_OS = xlsread('IMU_upperbody_sub17_heave_OS_00B4242B.xls');
raw_IMU_data_sub18_OS = xlsread('IMU_upperbody_sub18_heave_OS_00B4242B.xls');
raw_IMU_data_sub19_OS = xlsread('IMU_upperbody_sub19_heave_OS_00B4242B.xls');
raw_IMU_data_sub20_OS = xlsread('IMU_upperbody_sub20_heave_OS_00B4242B.xls');
raw_IMU_data_sub21_OS = xlsread('IMU_upperbody_sub21_heave_OS_00B4242B.xls');
raw_IMU_data_sub22_OS = xlsread('IMU_upperbody_sub22_heave_OS_00B4242B.xls');
raw_IMU_data_sub23_OS = xlsread('IMU_upperbody_sub23_heave_OS_00B4242B.xls');
raw_IMU_data_sub24_OS = xlsread('IMU_upperbody_sub24_heave_OS_00B4242B.xls');

% load data first trial 24 participants (t1 = trial 1)
raw_IMU_data_sub01_t1 = xlsread('IMU_upperbody_sub01_heave_t1_00B4242B.xls');
raw_IMU_data_sub02_t1 = xlsread('IMU_upperbody_sub02_heave_t1_00B4242B.xls');
raw_IMU_data_sub03_t1 = xlsread('IMU_upperbody_sub03_heave_t1_00B4242B.xls');
raw_IMU_data_sub04_t1 = xlsread('IMU_upperbody_sub04_heave_t1_00B4242B.xls');
raw_IMU_data_sub05_t1 = xlsread('IMU_upperbody_sub05_heave_t1_00B4242B.xls');
raw_IMU_data_sub06_t1 = xlsread('IMU_upperbody_sub06_heave_t1_00B4242B.xls');
raw_IMU_data_sub07_t1 = xlsread('IMU_upperbody_sub07_heave_t1_00B4242B.xls');
raw_IMU_data_sub08_t1 = xlsread('IMU_upperbody_sub08_heave_t1_00B4242B.xls');
raw_IMU_data_sub09_t1 = xlsread('IMU_upperbody_sub09_heave_t1_00B4242B.xls');
raw_IMU_data_sub10_t1 = xlsread('IMU_upperbody_sub10_heave_t1_00B4242B.xls');
raw_IMU_data_sub11_t1 = xlsread('IMU_upperbody_sub11_heave_t1_00B4242B.xls');
raw_IMU_data_sub12_t1 = xlsread('IMU_upperbody_sub12_heave_t1_00B4242B.xls');
raw_IMU_data_sub13_t1 = xlsread('IMU_upperbody_sub13_heave_t1_00B4242B.xls');
raw_IMU_data_sub14_t1 = xlsread('IMU_upperbody_sub14_heave_t1_00B4242B.xls');
raw_IMU_data_sub15_t1 = xlsread('IMU_upperbody_sub15_heave_t1_00B4242B.xls');
raw_IMU_data_sub16_t1 = xlsread('IMU_upperbody_sub16_heave_t1_00B4242B.xls');
raw_IMU_data_sub17_t1 = xlsread('IMU_upperbody_sub17_heave_t1_00B4242B.xls');
raw_IMU_data_sub18_t1 = xlsread('IMU_upperbody_sub18_heave_t1_00B4242B.xls');
raw_IMU_data_sub19_t1 = xlsread('IMU_upperbody_sub19_heave_t1_00B4242B.xls');
raw_IMU_data_sub20_t1 = xlsread('IMU_upperbody_sub20_heave_t1_00B4242B.xls');
raw_IMU_data_sub21_t1 = xlsread('IMU_upperbody_sub21_heave_t1_00B4242B.xls');
raw_IMU_data_sub22_t1 = xlsread('IMU_upperbody_sub22_heave_t1_00B4242B.xls');
raw_IMU_data_sub23_t1 = xlsread('IMU_upperbody_sub23_heave_t1_00B4242B.xls');
raw_IMU_data_sub24_t1 = xlsread('IMU_upperbody_sub24_heave_t1_00B4242B.xls');

% load data second trial for 24 participants (t2 = trial 2)
raw_IMU_data_sub01_t2 = xlsread('IMU_upperbody_sub01_heave_t2_00B4242B.xls');
raw_IMU_data_sub02_t2 = xlsread('IMU_upperbody_sub02_heave_t2_00B4242B.xls');
raw_IMU_data_sub03_t2 = xlsread('IMU_upperbody_sub03_heave_t2_00B4242B.xls');
raw_IMU_data_sub04_t2 = xlsread('IMU_upperbody_sub04_heave_t2_00B4242B.xls');
raw_IMU_data_sub05_t2 = xlsread('IMU_upperbody_sub05_heave_t2_00B4242B.xls');
raw_IMU_data_sub06_t2 = xlsread('IMU_upperbody_sub06_heave_t2_00B4242B.xls');
raw_IMU_data_sub07_t2 = xlsread('IMU_upperbody_sub07_heave_t2_00B4242B.xls');
raw_IMU_data_sub08_t2 = xlsread('IMU_upperbody_sub08_heave_t2_00B4242B.xls');
raw_IMU_data_sub09_t2 = xlsread('IMU_upperbody_sub09_heave_t2_00B4242B.xls');
raw_IMU_data_sub10_t2 = xlsread('IMU_upperbody_sub10_heave_t2_00B4242B.xls');
raw_IMU_data_sub11_t2 = xlsread('IMU_upperbody_sub11_heave_t2_00B4242B.xls');
raw_IMU_data_sub12_t2 = xlsread('IMU_upperbody_sub12_heave_t2_00B4242B.xls');
raw_IMU_data_sub13_t2 = xlsread('IMU_upperbody_sub13_heave_t2_00B4242B.xls');
raw_IMU_data_sub14_t2 = xlsread('IMU_upperbody_sub14_heave_t2_00B4242B.xls');
raw_IMU_data_sub15_t2 = xlsread('IMU_upperbody_sub15_heave_t2_00B4242B.xls');
raw_IMU_data_sub16_t2 = xlsread('IMU_upperbody_sub16_heave_t2_00B4242B.xls');
raw_IMU_data_sub17_t2 = xlsread('IMU_upperbody_sub17_heave_t2_00B4242B.xls');
raw_IMU_data_sub18_t2 = xlsread('IMU_upperbody_sub18_heave_t2_00B4242B.xls');
raw_IMU_data_sub19_t2 = xlsread('IMU_upperbody_sub19_heave_t2_00B4242B.xls');
raw_IMU_data_sub20_t2 = xlsread('IMU_upperbody_sub20_heave_t2_00B4242B.xls');
raw_IMU_data_sub21_t2 = xlsread('IMU_upperbody_sub21_heave_t2_00B4242B.xls');
raw_IMU_data_sub22_t2 = xlsread('IMU_upperbody_sub22_heave_t2_00B4242B.xls');
raw_IMU_data_sub23_t2 = xlsread('IMU_upperbody_sub23_heave_t2_00B4242B.xls');
raw_IMU_data_sub24_t2 = xlsread('IMU_upperbody_sub24_heave_t2_00B4242B.xls');

%% Delete rows and columns with no or useless data and make equal sized columns

% CHANGE THIS TO THE COLUMN NUMBER WHICH CONTAINS THE HEAVE ACC. DATA NOW
...
save(   'D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\IMU_data\Upperbody\Heave\cell_array_heave_IMU_UB_data_24subs.mat',...
