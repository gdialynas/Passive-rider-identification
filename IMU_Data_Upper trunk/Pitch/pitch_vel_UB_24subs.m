%% Processing and analysing raw pitch IMU data for upperbody for 24 subjects
...
clearvars pitch_acc_amp05 pitch_dis_amp05

% !!! CHANGE mat-file FOR CORRECT MOTION HERE !!!
% Measured force signals
IMU_data  = load('cell_array_pitch_upperbody_IMU_data_24subs.mat');

%% Define the correct sign convention here
des_pert    = pitch_vel_amp05;
clearvars pitch_vel_amp05
...
pitch_vel_upperbody_signals_SI_t1 = final_vel_t1; 
pitch_vel_upperbody_signals_SI_t2 = final_vel_t2;

%%% !!! STORE IN SAME DIRECTORY THAT CONTAINS THE TRANSFER FUNCTION SCRIPT FOR RIDER ID !!! %%% 
save('D:\gdialynas\Desktop\My files\Passive rider project\Jelle_de_hann_final\IMU_data\Upperbody\Pitch\pitch_vel_upperbody_signals_SI_t1_t2.mat','pitch_vel_upperbody_signals_SI_t1','pitch_vel_upperbody_signals_SI_t2');
